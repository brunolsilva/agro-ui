 ...
 window.onload = function () {
    ...
    switch (browser.name) {
        case "MSIE":
            ...
            break;
        case "Firefox":
            if (parseInt(browser.version) <= 32) {
                old = true;
            }
            break;
        case "Safari":
